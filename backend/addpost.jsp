                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="container">
                            ...
                            <div class="col-lg-11 contact-form__wrapper p-5 order-lg-1">
                                <form action="/newblog/add" method="post" class="contact-form form-validate" novalidate="novalidate">
                                    <div class="row">
                                        <div class="mb-3">
                                        ...
                                        <div class=" mb-3">
                                            <div class="form-group">
                                                <label class="required-field" for="email">authod</label>
                                        ...
                                        <div class=" mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" id="phone" name="Category">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="message" name="Content" rows="4"></textarea>
                                            </div>
                                        </div>
