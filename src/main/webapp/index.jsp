...
<body>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="<%=request.getContextPath()%>/index.jsp" class="logo d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="<%=request.getContextPath()%>/index.jsp">Blog</a></li>
          <li><a href="<%=request.getContextPath()%>/single-post.html">Single Post</a></li>
          ...
          <li><a href="contact.html">Contact</a></li>
            <li class="dropdown"><a href="#"><span class="bi bi-person-circle"></span> <i
                  class="bi bi-chevron-down dropdown-indicator"></i></a>
              <ul>
                <li><a href="backend/register.html">SignUP</a></li>
  ...
  // // Get all the slider images
    const sliderImages = document.querySelectorAll('.sliderFeaturedPosts .swiper-slide');

    // Create an array to store the slider data
    const sliderData = [];

    // Loop through each slider image
    sliderImages.forEach((image) => {
      // Get the image background URL
      const imageUrl = image.style.backgroundImage;

      // Remove the extra backslashes from the URL
      const cleanedUrl = imageUrl.replace(/\\+/g, '').replace(/"/g, '');

      // Get the slider title and content
      const title = image.querySelector('h2').textContent;
      const content = image.querySelector('p').textContent;

      // Create an object to store the slider data
      const sliderItem = {
        imageUrl: cleanedUrl,
        title: title,
        content: content  
      ...
      // Add the slider item to the array
      sliderData.push(sliderItem);
    });

    // Store the slider data in local storage as a JSON string
